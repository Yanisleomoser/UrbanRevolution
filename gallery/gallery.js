...
const SOURCES = [
    ...
    [A("hero-2.jpg"), "Halcyon Blazer", "Tailoring"],
    [A("hero-3.jpg"), "Meridian Dress", "Couture"],
    [A("hero-4.jpg"), "Undertow Parka", "Outerwear"],
    [A("hero-5.jpg"), "Riptide Shirt", "Atelier"],
    [A("hero-6.jpg"), "Sound & Salt", "Editorial"],
    [A("hero-wide.jpg"), "The Atelier Floor", "Archive"],
