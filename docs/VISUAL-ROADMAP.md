...
| **Your style** | `#your-style` | The identity climax + the ONE `--accent-warm` use. A generative "one warm thread bends out of the cool rack" (SVG/canvas). NO human portrait (reads as customer/testimonial). |
