...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "engine.dsc_understood": "// Verstanden — die Maschine liest zurück",
      "engine.dsc_none": "Noch nichts erkannt — nenn Stück, Farbe, Stoff oder Details.",
      "engine.dsc_apply": "Übernehmen & weiter",
      "engine.dsc_remove": "{what} entfernen",
      "engine.dsc_skipped": "Schritt für Schritt",
      "engine.dsc_read_label": "Gelesen",
      "engine.dsc_form": "FORM",
      "engine.dsc_color": "FARBE",
      "engine.dsc_material": "STOFF",
      "engine.dsc_fit": "PASSFORM",
      "engine.dsc_pattern": "MUSTER",
      "engine.dsc_finish": "OBERFLÄCHE",
      "engine.dsc_length": "LÄNGE",
      "engine.dsc_collar": "KRAGEN",
      "engine.dsc_closure": "VERSCHLUSS",
      "engine.dsc_pockets": "TASCHEN",
      ...
      "engine.slider_mid": "Ausgewogen",
      "engine.gallery_hint": "Startpunkte aus deinen bisherigen Entscheidungen — kein fertiges Stück. Du änderst danach alles weiter.",
      "engine.gallery_scratch": "Lieber von null anfangen",
      "engine.gallery_pick_aria": "Startpunkt übernehmen: {name}",
      ...
      "measure.privacy_label": "[ 100 % CLIENTSEITIG ]",
      "measure.photo_privacy": "Dein Bild verlässt nie dein Gerät — die Analyse läuft komplett im Browser.",
      ...
      "spec.draft_stamp": "WARTET AUF DEINEN ENTWURF",
      ...
      "toast.need_measurements": "Bitte gib zuerst deine Körpermasse ein",
      ...
      // Akt II — Die Maschine (der Kreis als Bauplan: laufende Ingenieur-
      // Simulation der geplanten autonomen Linie; vereint die früheren
      // Loop-/KI-/How-Beats in EINER Sektion — js/machine.js)
      "machine.label": "Akt II — Der Kreis",
      "machine.title": "Abfall rein. Einzelstück raus.",
      "machine.status": "Status: Vision — noch nicht gebaut",
      "machine.sub": "Der Bauplan läuft als Simulation. Die Fabrik noch nicht.",
      "machine.svg_aria": "Ingenieur-Simulation der geplanten autonomen Linie: Ballen werden auf ein Förderband entstapelt, eine Nahinfrarot-Scannerbrücke liest jedes Kleidungsstück, ein Verteiler lenkt es in Remake-, Panel- oder Faser-Ströme, und eine Remake-Zelle schneidet den Entwurf des Besuchers. Das automatische Nähmodul ist gestrichelt gezeichnet, weil es noch nicht existiert. Fertige Einzelstücke hängen an einer Ausgangs-Schiene.",
      "machine.scroll_aria": "Maschinen-Zeichnung — horizontal scrollbar",
      "machine.swipe": "wischen →",
      "machine.stamp": "SIMULATION · KONSTRUKTIONSSTAND",
      "machine.plate_rev": "UR-LINIE-01 · REV 01 · NICHT GEBAUT",
      "machine.z1": "01 · EINGANG",
      "machine.z2": "02 · AUTONOME SORTIERUNG",
      "machine.z3": "03 · SORTIERTE STRÖME",
      "machine.z4": "04 · REMAKE-ZELLE",
      "machine.z5": "05 · AUSGANG",
      "machine.legend_solid": "MASCHINEN, DIE ES HEUTE GIBT",
      "machine.legend_dashed": "DER UNGELÖSTE SCHRITT — AUTONOMES NÄHEN",
      "machine.pile": "ALTKLEIDER",
      "machine.scanner": "NIR + VISION — LIEST JEDES TEIL",
      "machine.lane1": "REMAKE-QUALITÄT",
      "machine.lane2": "PANEL-QUALITÄT",
      "machine.lane3": "FASER-QUALITÄT",
      "machine.cell": "REMAKE-ZELLE",
      "machine.badge": "NOCH UNGELÖST",
      "machine.sew": "AUTONOMES NÄHEN",
      "machine.print": "ETIKETT-DRUCK",
      "machine.yours": "DEINS",
      "machine.no_none": "Nr. ————",
      "machine.tag_empty": "1/1 · Nr. ————",
      "machine.tag_no": "1/1 · Nr. {no}",
      "machine.no": "Nr. {no}",
      "machine.st_ready": "BEREIT",
      "machine.st_cut": "SCHNITT",
      "machine.st_cut_no": "SCHNITT · NR. {no}",
      "machine.st_sew": "NAHT — NOCH UNGELÖST",
      "machine.st_fin": "FERTIGSTELLUNG",
      "machine.st_label": "NR. {no} · ETIKETTIERT",
      "machine.st_label0": "ETIKETTIERT",
      "machine.st_rail": "NR. {no} · AUF DER SCHIENE",
      "machine.st_rail0": "AUF DER SCHIENE",
      "machine.st_reset": "RÜSTEN",
      "machine.st_one": "EINS NACH DEM ANDEREN",
      "machine.chip1": "BAUMWOLLE 92% · KLASSE A → REMAKE",
      "machine.chip2": "DENIM · BAUMWOLLE 98% → PANELS",
      "machine.chip3": "LEINEN 88% · KLASSE B → REMAKE",
      "machine.chip4": "WOLLE 60% MISCHUNG → FASER",
      "machine.chip5": "POLYESTER 100% → FASER",
      "machine.file": "AUF DER LINIE: NR. {no} — DEIN ENTWURF AUS DEM STUDIO",
      "machine.file_none": "EIN BÜGEL BLEIBT FREI — DEINS · ENTWIRF IM STUDIO",
      "machine.stations_aria": "Die vier Stationen des Kreislaufs",
      "machine.zoom_hint": "Diese Stufe ansehen →",
      "machine.s1_idx": "01 — Eingang",
      "landing.stage1_title": "Getragen",
      "landing.stage1_tag": "Alle",
      "machine.s1_text": "Kleidung mit Geschichte — gesammelt statt deponiert.",
      "machine.s1_flow": "BALLEN → BAND → EIN TEIL AUFS MAL",
      "machine.s2_idx": "02 — Sortierung",
      "landing.stage2_title": "Zurückgewonnen",
      "landing.stage2_tag": "KI",
      "machine.s2_text": "Nahinfrarot soll Faser, Farbe, Zustand lesen.",
      "machine.s2_flow": "SCAN → REMAKE · PANEL · FASER",
      "machine.s3_idx": "03 — Remake-Zelle",
      "landing.stage3_title": "Entworfen",
      "landing.stage3_tag": "Du",
      "machine.s3_text": "Deine Vorlage ist die Schnittdatei — dein Stil, deine Masse.",
      "machine.s3_flow": "PANEL → SCHNITT UM VERSCHLEISS",
      "machine.s4_idx": "04 — Ausgang",
      "landing.stage4_title": "Wiedergeboren",
      "landing.stage4_tag": "KI",
      "machine.s4_text": "Autonomes Nähen bleibt ungelöst — gestrichelt, bis es echt ist.",
      "machine.s4_flow": "SCHNITT → NAHT ┄ UNGELÖST → DEINS",
      "machine.confess_html": "Nichts davon ist gebaut. <strong>Lieber zeigen wir dir den Bauplan, als so zu tun.</strong>",
      "machine.anchors_label": "PRÜFBAR",
      "machine.anchor1": "NIR-SORTIERUNG · INDUSTRIELL SEIT 2020 (SIPTEX MALMÖ)",
      "machine.anchor2": "DEMONTAGE-NÄHTE ÖFFNEN KLEIDUNG AUF KNOPFDRUCK (RESORTECS)",
      "machine.anchor3": "AUTONOMES NÄHEN IM ALLGEMEINEN — UNGELÖST",
      ...
      "aidr.dim_p": "Füttert die Linie — erzeugt neue Bedürfnisse.",
      "aidr.lit_tag": "Im Kreis",
      "aidr.lit_h": "Sehen, trennen, zurückgewinnen",
      "aidr.lit_p": "Dieselbe KI, auf den Abfallberg gerichtet.",
      "aidr.role1": "SORTIEREN → MASCHINE",
      "aidr.role2": "FERTIGEN → MASCHINE",
      "aidr.role3": "ENTWERFEN → DU",
      "aidr.never": "Die KI entwirft nie.",

      "how.label": "So funktioniert's",
      "how.sub": "Du hältst den Faden, die Maschine die Nadel.",
      "how.s1_label": "Du entwirfst",
      "how.s1_line": "Ein Satz genügt. Die Idee bleibt deine.",
      "how.s2_label": "Du entscheidest",
      "how.s2_line": "Die Engine fragt — du wählst Schnitt, Stoff, Farbe.",
      "how.s3_label": "Deine Masse",
      "how.s3_line": "Neun Werte — per Foto im Browser, von Hand oder Preset.",
      "how.s4_label": "Deine Vorlage",
      "how.s4_line": "Dokumentiert — bereit, wenn der Kreis sich zum ersten Mal schliesst.",
    ...
    en: {
      ...
      "engine.dsc_understood": "// Understood — the machine reads back",
      "engine.dsc_none": "Nothing read yet — name the piece, colour, fabric or details.",
      "engine.dsc_apply": "Apply & continue",
      "engine.dsc_remove": "Remove {what}",
      "engine.dsc_skipped": "Step by step",
      "engine.dsc_read_label": "Read",
      "engine.dsc_form": "FORM",
      "engine.dsc_color": "COLOUR",
      "engine.dsc_material": "FABRIC",
      "engine.dsc_fit": "FIT",
      "engine.dsc_pattern": "PATTERN",
      "engine.dsc_finish": "FINISH",
      "engine.dsc_length": "LENGTH",
      "engine.dsc_collar": "COLLAR",
      "engine.dsc_closure": "CLOSURE",
      "engine.dsc_pockets": "POCKETS",
      ...
      "engine.phase_details": "Details",
      "engine.confirm": "Next",
      "engine.slider_mid": "Balanced",
      "engine.gallery_hint": "Starting points drawn from what you've decided so far — not finished pieces. You keep changing everything after this.",
      "engine.gallery_scratch": "Rather start from scratch",
      "engine.gallery_pick_aria": "Take this starting point: {name}",
      ...
      "measure.privacy_label": "[ 100 % CLIENT-SIDE ]",
      "measure.photo_privacy": "Your image never leaves your device — the analysis runs entirely in your browser.",
      ...
      "spec.draft_stamp": "AWAITING YOUR DESIGN",
      ...
      "toast.need_measurements": "Please enter your body measurements first",
      ...
      // Act II — The Machine (the circle as blueprint: running engineering
      // simulation of the planned autonomous line; merges the former
      // loop/AI/how beats into ONE section — js/machine.js)
      "machine.label": "Act II — The Circle",
      "machine.title": "Waste in. One-off out.",
      "machine.status": "Status: vision — not yet built",
      "machine.sub": "The blueprint runs as a simulation. The factory doesn't yet.",
      "machine.svg_aria": "Engineering simulation of the planned autonomous line: bales are destacked onto a conveyor, a near-infrared scanner bridge reads every garment, a diverter routes it into remake, panel or fibre streams, and a remake cell cuts the visitor's design. The automatic sewing module is drawn dashed because it does not exist yet. Finished one-offs hang on an outbound rail.",
      "machine.scroll_aria": "Machine drawing — scrolls horizontally",
      "machine.swipe": "swipe →",
      "machine.stamp": "SIMULATION · ENGINEERING DRAFT",
      "machine.plate_rev": "UR-LINE-01 · REV 01 · NOT BUILT",
      "machine.z1": "01 · INTAKE",
      "machine.z2": "02 · AUTONOMOUS SORTING",
      "machine.z3": "03 · SORTED STREAMS",
      "machine.z4": "04 · REMAKE CELL",
      "machine.z5": "05 · OUTBOUND",
      "machine.legend_solid": "MACHINES THAT EXIST TODAY",
      "machine.legend_dashed": "THE UNSOLVED STEP — AUTONOMOUS SEWING",
      "machine.pile": "DISCARDED CLOTHES",
      "machine.scanner": "NIR + VISION — READS EVERY PIECE",
      "machine.lane1": "REMAKE GRADE",
      "machine.lane2": "PANEL GRADE",
      "machine.lane3": "FIBRE GRADE",
      "machine.cell": "REMAKE CELL",
      "machine.badge": "STILL UNSOLVED",
      "machine.sew": "AUTONOMOUS SEWING",
      "machine.print": "LABEL PRINT",
      "machine.yours": "YOURS",
      "machine.no_none": "No. ————",
      "machine.tag_empty": "1/1 · No. ————",
      "machine.tag_no": "1/1 · No. {no}",
      "machine.no": "No. {no}",
      "machine.st_ready": "READY",
      "machine.st_cut": "CUTTING",
      "machine.st_cut_no": "CUTTING · NO. {no}",
      "machine.st_sew": "SEAM — STILL UNSOLVED",
      "machine.st_fin": "FINISHING",
      "machine.st_label": "NO. {no} · LABELLED",
      "machine.st_label0": "LABELLED",
      "machine.st_rail": "NO. {no} · ON THE RAIL",
      "machine.st_rail0": "ON THE RAIL",
      "machine.st_reset": "RESETTING",
      "machine.st_one": "ONE AT A TIME",
      "machine.chip1": "COTTON 92% · GRADE A → REMAKE",
      "machine.chip2": "DENIM · COTTON 98% → PANELS",
      "machine.chip3": "LINEN 88% · GRADE B → REMAKE",
      "machine.chip4": "WOOL 60% BLEND → FIBRE",
      "machine.chip5": "POLYESTER 100% → FIBRE",
      "machine.file": "ON THE LINE: NO. {no} — YOUR DESIGN FROM THE STUDIO",
      "machine.file_none": "ONE HANGER STAYS FREE — YOURS · DESIGN IT IN THE STUDIO",
      "machine.stations_aria": "The four stations of the loop",
      "machine.zoom_hint": "View this stage →",
      "machine.s1_idx": "01 — Intake",
      "landing.stage1_title": "Worn",
      "landing.stage1_tag": "All",
      "machine.s1_text": "Clothing with a past — collected, not landfilled.",
      "machine.s1_flow": "BALE → BELT → ONE PIECE AT A TIME",
      "machine.s2_idx": "02 — Sorting",
      "landing.stage2_title": "Reclaimed",
      "landing.stage2_tag": "AI",
      "machine.s2_text": "Near-infrared is meant to read fibre, colour, condition.",
      "machine.s2_flow": "SCAN → REMAKE · PANEL · FIBRE",
      "machine.s3_idx": "03 — Remake cell",
      "landing.stage3_title": "Designed",
      "landing.stage3_tag": "You",
      "machine.s3_text": "Your template is the cut file — your style, your measurements.",
      "machine.s3_flow": "PANEL → CUT AROUND WEAR",
      "machine.s4_idx": "04 — Outbound",
      "landing.stage4_title": "Reborn",
      "landing.stage4_tag": "AI",
      "machine.s4_text": "Autonomous sewing stays unsolved — dashed until it is real.",
      "machine.s4_flow": "CUT → SEAM ┄ UNSOLVED → YOURS",
      "machine.confess_html": "None of this is built. <strong>We'd rather show you the blueprint than pretend.</strong>",
      "machine.anchors_label": "VERIFIABLE",
      "machine.anchor1": "NIR SORTING · INDUSTRIAL SINCE 2020 (SIPTEX MALMÖ)",
      "machine.anchor2": "DISASSEMBLY STITCHES OPEN GARMENTS ON DEMAND (RESORTECS)",
      "machine.anchor3": "AUTONOMOUS SEWING IN GENERAL — UNSOLVED",
      ...
      "aidr.dim_p": "Feeds the line — manufactures new wants.",
      "aidr.lit_tag": "In the circle",
      "aidr.lit_h": "See, separate, reclaim",
      "aidr.lit_p": "The same AI, aimed at the waste pile.",
      "aidr.role1": "SORT → MACHINE",
      "aidr.role2": "MAKE → MACHINE",
      "aidr.role3": "DESIGN → YOU",
      "aidr.never": "The AI never designs.",

      "how.label": "How it works",
      "how.sub": "You hold the thread, the machine the needle.",
      "how.s1_label": "You design",
      "how.s1_line": "One sentence is enough. The idea stays yours.",
      "how.s2_label": "You decide",
      "how.s2_line": "The engine asks — you choose cut, fabric, colour.",
      "how.s3_label": "Your measurements",
      "how.s3_line": "Nine values — via photo in the browser, by hand, or preset.",
      "how.s4_label": "Your blueprint",
      "how.s4_line": "Documented — ready for the day the circle first closes.",
