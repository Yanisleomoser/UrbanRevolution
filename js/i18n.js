...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "machine.sub": "Eine Fabrik, deren Fliessband kein Ende hat — vier Stationen, ein Kreis. Das hier ist ihr Bauplan, als laufende Simulation.",
      ...
      "machine.file": "Auf der Linie: Nr. {no} — dein Entwurf aus dem Studio, geschnitten in der Remake-Zelle.",
      "machine.file_none": "Ein Bügel bleibt frei — deins. Entwirf dein Stück im Studio, und die Remake-Zelle schneidet deine Vorlage hier.",
      ...
      "machine.s1_text": "Jedes Stück beginnt als Kleidung mit Geschichte — gesammelt statt deponiert. Ballen öffnen sich auf ein Pufferband; Greifer heben ein Teil aufs Mal.",
      "machine.s2_idx": "02 — Sortierung",
      "landing.stage2_title": "Zurückgewonnen",
      "landing.stage2_tag": "KI",
      "machine.s2_text": "Stoffe, Knöpfe, Nähte: Eine Nahinfrarot-Brücke soll Faser, Farbe und Zustand in Sekunden lesen — und jedes Teil in seinen Strom lenken: Remake, Panel oder Faser.",
      "machine.s3_idx": "03 — Remake-Zelle",
      "landing.stage3_title": "Entworfen",
      "landing.stage3_tag": "Du",
      "machine.s3_text": "Deine Vorlage aus dem Studio ist die Schnittdatei: Die Zelle soll zurückgewonnene Panels scannen und deinen Entwurf um Verschleiss herum schneiden — dein Stil, deine Masse.",
      "machine.s4_idx": "04 — Ausgang",
      "landing.stage4_title": "Wiedergeboren",
      "landing.stage4_tag": "KI",
      "machine.s4_text": "Autonomes Nähen ist der ungelöste Schritt — gestrichelt gezeichnet, bis es echt ist. Dann hängt am Ausgang genau ein Stück: deins.",
      "machine.confess_html": "Nichts davon ist gebaut. <strong>Lieber zeigen wir dir den Bauplan, als so zu tun.</strong>",
      "machine.honest": "Prüfbare Anker statt Hype: Nahinfrarot-Sortierung läuft seit 2020 im Industriemassstab (SIPTex Malmö) · Roboter beschicken heute Faltmaschinen mit weicher Wäsche · Demontage-Nähte öffnen Kleidung auf Knopfdruck (Resortecs) — und nichts davon näht Kleidung im Allgemeinen. Genau diese Lücke ist oben gestrichelt gezeichnet.",
    ...
    en: {
      ...
      "machine.sub": "A factory whose conveyor has no end — four stations, one circle. This is its blueprint, running as a simulation.",
      ...
      "machine.file": "On the line: No. {no} — your design from the studio, cut in the remake cell.",
      "machine.file_none": "One hanger stays open — yours. Design your piece in the studio and the remake cell cuts your blueprint here.",
      ...
      "machine.s1_text": "Every piece begins as clothing with history — collected, not landfilled. Bales open onto a buffer belt; grippers lift one piece at a time.",
      "machine.s2_idx": "02 — Sorting",
      "landing.stage2_title": "Reclaimed",
      "landing.stage2_tag": "AI",
      "machine.s2_text": "Fabric, buttons, seams: a near-infrared bridge is meant to read fibre, colour and condition in seconds — and route every piece into its stream: remake, panel or fibre.",
      "machine.s3_idx": "03 — Remake cell",
      "landing.stage3_title": "Designed",
      "landing.stage3_tag": "You",
      "machine.s3_text": "Your blueprint from the studio is the cutting file: the cell is meant to scan reclaimed panels and cut your design around wear — your style, your measurements.",
      "machine.s4_idx": "04 — Outbound",
      "landing.stage4_title": "Reborn",
      "landing.stage4_tag": "AI",
      "machine.s4_text": "Autonomous sewing is the unsolved step — drawn dashed until it's real. Then exactly one piece hangs at the outbound rail: yours.",
      "machine.confess_html": "None of this is built. <strong>We'd rather show you the blueprint than pretend.</strong>",
      "machine.honest": "Verifiable anchors, not hype: near-infrared sorting has run at industrial scale since 2020 (SIPTex Malmö) · robots already feed folding machines with soft laundry · disassembly stitching opens garments on demand (Resortecs) — and none of it sews garments in general. That exact gap is drawn dashed above.",
