...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "hero2.sub": "Entwirf einzigartige Mode-Konzepte mit UR Create — und entdecke eine neue Alternative zu massenproduzierter Mode.",
      ...
      "hero2.caption": "[ LIVE · EIN KONZEPT ENTWICKELT SICH ]",
      "urcreate.label": "[ UR CREATE ]",
      "urcreate.h2": "Deine Vorstellungskraft kommt zuerst",
      "urcreate.intro": "Die meiste Mode beginnt mit Produktion. Was passiert, wenn sie bei Menschen beginnt? Erschaffe, entwickle weiter, mach sie zu deiner.",
      ...
      "look.label": "[ KONZEPTE ]",
      "look.h2": "Was entsteht, wenn Menschen zuerst kommen",
      ...
      "gal.why_html": "Warum zählt das? <span aria-hidden=\"true\">↓</span>",
      "gal.view": "Ansehen",
      "gal.remix": "Remixen",
      ...
      "alt.headline_html": "Was wäre, wenn Mode <em>bei Menschen</em> begänne?",
      "alt.cta_html": "Stell dir ein anderes System vor <span aria-hidden=\"true\">→</span>",
      "vision.label": "[ VISION ]",
      "vision.h2": "Mode sollte bei Menschen beginnen",
      "vision.s1": "Heute",
    ...
    en: {
      ...
      "hero2.caption": "[ LIVE · A CONCEPT EVOLVING ]",
      "urcreate.label": "[ UR CREATE ]",
      ...
      "gal.why_html": "Why does this matter? <span aria-hidden=\"true\">↓</span>",
      "gal.view": "View",
      "gal.remix": "Remix",
