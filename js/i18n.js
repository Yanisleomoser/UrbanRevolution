...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "factsLab.label": "Variante",
      "factsLab.nav": "Facts-Variante wählen",
      "factsLab.a": "Variante A — Das Protokoll",
      "factsLab.b": "Variante B — Die Masse",
      "factsLab.c": "Variante C — Die Linie",
      "factsA.scale_tag": "Globale CO₂-Emissionen gesamt = 100",
      "factsA.tag_fashion": "Mode ≤ 8 %",
      "factsA.ref_flights": "Internationale Flüge ~2 %",
      "factsA.ref_ships": "Schifffahrt ~2 %",
      "factsA.co2_note": "mehr als internationale Flüge und Schifffahrt zusammen — Ellen MacArthur Foundation",
      "factsA.strip_legend": "1 Strich = 1 Sekunde = 1 Lkw-Ladung",
      "factsA.dots_legend": "≙ 1 von 100 Kleidungsstücken",
      ...
      "factsC.fan_cap": "100 Stränge = alle globalen CO₂-Emissionen. Die schweren Kabel: bis zu acht — die Mode.",
      "factsC.tag_flights": "Flüge ~2 %",
      "factsC.tag_shipping": "Schifffahrt ~2 %",
      "factsC.co2_note": "Textilproduktion: ≈ 1,2 Mrd. t CO₂e pro Jahr — mehr als internationale Flüge (~2 %) und Schifffahrt (~2 %) zusammen. — EMF, 2017",
      "factsC.ratchet_cap": "1 Stufe = 1 Sekunde = 1 Lkw-Ladung",
      "factsC.tag99": "99 von 100 — immer weiter",
    ...
    en: {
      ...
      "factsLab.label": "Variant",
      "factsLab.nav": "Choose facts variant",
      "factsLab.a": "Variant A — The Protocol",
      "factsLab.b": "Variant B — The Mass",
      "factsLab.c": "Variant C — The Line",
      "factsA.scale_tag": "Total global CO₂ emissions = 100",
      "factsA.tag_fashion": "Fashion ≤ 8 %",
      "factsA.ref_flights": "International flights ~2 %",
      "factsA.ref_ships": "Maritime shipping ~2 %",
      "factsA.co2_note": "more than international flights and maritime shipping combined — Ellen MacArthur Foundation",
      "factsA.strip_legend": "1 tick = 1 second = 1 truckload",
      "factsA.dots_legend": "≙ 1 in 100 garments",
      ...
      "factsC.fan_cap": "100 strands = all global CO₂ emissions. The heavy cables: up to eight — fashion.",
      "factsC.tag_flights": "Flights ~2 %",
      "factsC.tag_shipping": "Shipping ~2 %",
      "factsC.co2_note": "Textile production: ≈ 1.2 bn t of CO₂e per year — more than international flights (~2 %) and maritime shipping (~2 %) combined. — EMF, 2017",
      "factsC.ratchet_cap": "1 step = 1 second = 1 truckload",
      "factsC.tag99": "99 of 100 — onwards, always",
