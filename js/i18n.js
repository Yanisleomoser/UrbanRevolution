...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "hero.subtitle": "Ein Satz genügt: Die KI entwirft dein Stück, und eine vollautonome Fabrik fertigt es aus sortierter, recycelter Faser weggeworfener Mode — nach deinen Massen, nur für dich.",
      ...
      "manifesto.vision": "Urban Revolution macht aus weggeworfenen Kleidern neuen Stoff. Du beschreibst ein Stück, unsere KI entwirft es, und eine vollautonome Fabrik sortiert die Faser weggeworfener Mode und fertigt daraus dein Stück nach deinen neun Massen. Ein Kleidungsstück. Einmal gefertigt. Für dich — aus genau dem, was die Branche wegwirft. Kein neuer Rohstoff, keine Überproduktion, keine Deponie.",
      ...
      "story.a5_headline_html": "Aus sortierter Faser wird dein Stück — KI-entworfen, autonom gefertigt, nach deinen Massen.",
      ...
      "prod.intro": "Alle Daten, die die autonome Fertigung benötigt, in einem Dokument.",
      ...
      "export.intro": "Lade die Vorlage herunter oder sende sie direkt an die autonome Fertigung.",
      ...
      "faq.q3": "Was kostet ein massgeschneidertes Stück?",
      "faq.a3": "Der Preis hängt von Stofftyp, Schnittkomplexität und gewählten Massen ab. Eine Spanne in CHF zeigen wir dir live in der Spec-Sheet-Vorschau — typisch CHF 145–220 für T-Shirts und Hemden, CHF 220–450 für Hosen und Jacken, CHF 380–680 für Mäntel und Kleider.",
      "faq.q4": "Was, wenn ich nicht gemessen wurde?",
      "faq.a4": "Drei Wege zu deinen Massen — Foto-Auswertung (1 Klick, 100 % clientseitig), manuelle Eingabe der 9 Werte, oder eine Grössenpresets (S/M/L/XL) als Startpunkt, die du danach anpassen kannst. Die autonome Fertigung erhält alle Werte in der Produktions-Spec.",
      "faq.q5": "Wo wird gefertigt?",
      "faq.a5": "Dein Stück entsteht in unserer vollautonomen Fabrik: weggeworfene Fast-Fashion wird automatisch sortiert, und autonome Roboter fertigen dein Design aus den recycelten Materialien — nach deiner Spec. Nachvollziehbar von der Alttextilie bis zum fertigen Stück, ohne Überproduktion.",
      ...
      // ── Footer ──
      "footer.tagline": "Massgeschneiderte Einzelstücke aus recycelter Mode. KI entwirft, autonome Roboter fertigen, du trägst.",
      ...
      "landing.sub": "KI-entworfene Einzelstücke nach Mass — aus Kleidung, die schon existiert. Keine Überproduktion. Kein Abfall. Nur deins.",
      ...
      "landing.manifesto": "Mode ist eine Linie geworden: produzieren, tragen, wegwerfen. Wir biegen die Linie zurück zum Kreis. Jedes Stück beginnt als Kleidung, die schon gelebt hat — und wird zu etwas, das es nur einmal gibt. Entworfen von KI. Autonom gefertigt. Gemacht für dich.",
      ...
      "landing.stage2_text": "Stoffe, Knöpfe, Nähte: Autonom sortiert — Altkleider werden zu Rohmaterial für Neues.",
      "landing.stage3_title": "Neu gedacht",
      "landing.stage3_text": "Du beschreibst deine Idee — die KI entwirft daraus ein Einzelstück nach deinen Massen.",
      "landing.stage4_title": "Wiedergeboren",
      "landing.stage4_text": "Eine vollautonome Fabrik fertigt dein Stück mit autonomen Robotern. Made for one. Not for all.",
    ...
    en: {
      ...
      "hero.subtitle": "One sentence is enough: the AI designs your piece, and a fully autonomous factory makes it from sorted fibre reclaimed from discarded fashion — to your measurements, for you alone.",
      ...
      "manifesto.vision": "Urban Revolution turns discarded clothes into new fabric. You describe a piece, our AI designs it, and a fully autonomous factory sorts the fibre from discarded fashion and makes it to your nine measurements. One garment, made once, for you — from exactly what the industry throws away. No virgin material, no overproduction, no landfill.",
      ...
      "story.a5_headline_html": "Sorted fibre becomes your piece — AI-designed, autonomously made, to your measurements.",
      ...
      "prod.intro": "All the data the autonomous factory needs, in a single document.",
      "spec.brief_h4": "Design brief",
      ...
      "export.intro": "Download the spec or send it straight to the factory.",
      ...
      "faq.a4": "Three ways to your measurements — photo analysis (1 click, 100% client-side), manual entry of the 9 values, or a size preset (S/M/L/XL) as a starting point you can adjust afterwards. The autonomous factory receives all values in the production spec.",
      "faq.q5": "Where is it made?",
      "faq.a5": "Your piece is made in our fully autonomous factory: discarded fast fashion is sorted automatically, and autonomous robots craft your design from the recycled materials — to your spec. Traceable from old garment to finished piece, with no overproduction.",
      ...
      // ── Footer ──
      "footer.tagline": "Made-to-measure one-of-ones from recycled fashion. AI designs, autonomous robots make, you wear.",
      ...
      "landing.h1_line1": "Made for one.",
      "landing.h1_line2": "Not for all.",
      "landing.sub": "AI-designed one-offs, cut to your measurements — from clothing that already exists. No overproduction. No waste. Only yours.",
      ...
      "landing.manifesto": "Fashion became a straight line: produce, wear, discard. We bend that line back into a circle. Every piece begins as clothing that has already lived — and becomes something that exists only once. Designed by AI. Autonomously made. Made for you.",
      ...
      "landing.stage2_text": "Fabric, buttons, seams: sorted autonomously — old garments become raw material for something new.",
      "landing.stage3_title": "Reimagined",
      "landing.stage3_text": "You describe your idea — AI turns it into a one-off design, cut to your measurements.",
      "landing.stage4_title": "Reborn",
      "landing.stage4_text": "A fully autonomous factory makes your piece with autonomous robots. Made for one. Not for all.",
