...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "how.sub": "Das ist deine Seite des Kreislaufs — vier Schritte vom ersten Prompt zur dokumentierten Vorlage. Du führst, die Maschine folgt.",
    ...
    en: {
      ...
      "how.sub": "This is your side of the circle — four steps from the first prompt to a documented blueprint. You lead, the machine follows.",
