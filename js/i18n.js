...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "landing.head.title": "Urban Revolution — Circular Couture aus Zürich",
      "landing.eyebrow": "Circular Couture · Zürich",
      "landing.h1_line1": "Made for one.",
      "landing.h1_line2": "Not for all.",
      "landing.sub": "KI-entworfene Einzelstücke nach Maß — aus Kleidung, die schon existiert. Keine Überproduktion. Kein Abfall. Nur deins.",
      "landing.cta_secondary": "Das Manifest",
      "landing.scroll": "Scrollen",
      "landing.marquee": "AI · 3D · Couture · Recycelt · Zürich · Made for one. Not for all. ·",
      "landing.manifesto_label": "Manifest",
      "landing.manifesto": "Mode ist eine Linie geworden: produzieren, tragen, wegwerfen. Wir biegen die Linie zurück zum Kreis. Jedes Stück beginnt als Kleidung, die schon gelebt hat — und wird zu etwas, das es nur einmal gibt. Entworfen von KI. Gefertigt von Hand. Gemacht für dich.",
      ...
      "landing.stage2_text": "Stoffe, Knöpfe, Nähte: Wir zerlegen Altkleider in Rohmaterial für Neues.",
      "landing.stage3_title": "Neu gedacht",
      "landing.stage3_text": "Du beschreibst deine Idee — die KI entwirft daraus ein Einzelstück nach deinen Maßen.",
      "landing.stage4_title": "Wiedergeboren",
      "landing.stage4_text": "Ein Schweizer Atelier fertigt dein Stück von Hand. Made for one. Not for all.",
      ...
      // ── UR Create · Das Atelier (eigenständige Design-Reise, create/) ──
      "create.kicker": "Das Atelier",
      "create.lang_aria": "Sprache wechseln",
      "create.loading": "Das Atelier öffnet …",
      "create.eyebrow": "Einzelstück · Schritt für Schritt",
      "create.threshold_title_html": "Forme etwas, das es <em>nur einmal</em> gibt.",
      "create.threshold_sub": "Fünf Entscheidungen. Ein Stück, das nur dir gehört — aus Kleidung, die schon existiert.",
      "create.begin": "Die Reise beginnen",
      "create.threshold_hint": "Ziehe jederzeit, um dein Stück zu drehen.",
      "create.drag": "Ziehen zum Drehen",
      "create.back": "Zurück",
      "create.next": "Weiter",
      "create.reveal": "Mein Stück zeigen",
      "create.ch_type_label": "Kapitel I · Silhouette",
      "create.ch_type_title": "Wähle die Form.",
      "create.ch_type_hint": "Jedes Stück beginnt als Silhouette.",
      "create.ch_material_label": "Kapitel II · Stoff",
      "create.ch_material_title": "Welcher Stoff?",
      "create.ch_material_hint": "Jeder Stoff stammt aus recycelter Kleidung.",
      "create.ch_color_label": "Kapitel III · Farbe",
      "create.ch_color_title": "Gib ihm Farbe.",
      "create.ch_color_hint": "Zehn Töne aus der Markenpalette.",
      "create.ch_pattern_label": "Kapitel IV · Muster",
      "create.ch_pattern_title": "Ein Muster?",
      "create.ch_pattern_hint": "Von schlicht uni bis floral — oder ganz ohne.",
      "create.ch_fit_label": "Kapitel V · Passform",
      "create.ch_fit_title": "Deine Passform.",
      "create.ch_fit_hint": "Eine Richtgröße — die genauen Maße verfeinern wir später gemeinsam.",
      "create.one_of_one": "Made for one. Not for all.",
      "create.finale_title": "Dein Einzelstück.",
      "create.spec_type": "Silhouette",
      "create.spec_material": "Stoff",
      "create.spec_color": "Farbe",
      "create.spec_pattern": "Muster",
      "create.spec_fit": "Passform",
      "create.to_life": "Ins Atelier geben",
      "create.again": "Neu beginnen",
    },
    ...
    en: {
      ...
      "landing.head.title": "Urban Revolution — Circular couture from Zurich",
      "landing.eyebrow": "Circular Couture · Zurich",
      "landing.h1_line1": "Made for one.",
      "landing.h1_line2": "Not for all.",
      ...
      "landing.marquee": "AI · 3D · Couture · Recycled · Zurich · Made for one. Not for all. ·",
      "landing.manifesto_label": "Manifesto",
      "landing.manifesto": "Fashion became a straight line: produce, wear, discard. We bend that line back into a circle. Every piece begins as clothing that has already lived — and becomes something that exists only once. Designed by AI. Made by hand. Made for you.",
      ...
      "landing.stage2_text": "Fabric, buttons, seams: we take old garments apart into raw material for something new.",
      ...
      "landing.stage4_text": "A Swiss atelier makes your piece by hand. Made for one. Not for all.",
      ...
      // ── UR Create · The Atelier (standalone design journey, create/) ──
      "create.kicker": "The Atelier",
      "create.lang_aria": "Switch language",
      "create.loading": "The atelier is opening …",
      "create.eyebrow": "One of one · step by step",
      "create.threshold_title_html": "Shape something that exists <em>only once</em>.",
      "create.threshold_sub": "Five decisions. A piece that belongs to you alone — from clothing that already exists.",
      "create.begin": "Begin the journey",
      "create.threshold_hint": "Drag anytime to turn your piece.",
      "create.drag": "Drag to turn",
      "create.back": "Back",
      "create.next": "Continue",
      "create.reveal": "Reveal my piece",
      "create.ch_type_label": "Chapter I · Silhouette",
      "create.ch_type_title": "Choose the form.",
      "create.ch_type_hint": "Every piece begins as a silhouette.",
      "create.ch_material_label": "Chapter II · Fabric",
      "create.ch_material_title": "Which fabric?",
      "create.ch_material_hint": "Every fabric is reclaimed from existing clothing.",
      "create.ch_color_label": "Chapter III · Colour",
      "create.ch_color_title": "Give it colour.",
      "create.ch_color_hint": "Ten tones from the brand palette.",
      "create.ch_pattern_label": "Chapter IV · Pattern",
      "create.ch_pattern_title": "A pattern?",
      "create.ch_pattern_hint": "From plain solid to floral — or none at all.",
      "create.ch_fit_label": "Chapter V · Fit",
      "create.ch_fit_title": "Your fit.",
      "create.ch_fit_hint": "A guide size — we refine the exact measurements together later.",
      "create.one_of_one": "Made for one. Not for all.",
      "create.finale_title": "Your one of one.",
      "create.spec_type": "Silhouette",
      "create.spec_material": "Fabric",
      "create.spec_color": "Colour",
      "create.spec_pattern": "Pattern",
      "create.spec_fit": "Fit",
      "create.to_life": "Send to the atelier",
      "create.again": "Start over",
    },
  };
