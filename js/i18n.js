...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "howto.s3_body": "Ein Schweizer Schneider näht dein Stück aus recyceltem, ozeangebundenem rPET — auf Bestellung, in rund 14 Tagen bei dir. Kein Lager, keine Überproduktion.",
    ...
    en: {
      ...
      "howto.s3_body": "A Swiss tailor sews your piece from recycled, ocean-bound rPET — on demand, at your door in about 14 days. No warehouse, no overproduction.",
