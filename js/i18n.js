...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "story.a0_headline_html": "Wir nähen über 100 Milliarden Kleidungsstücke pro Jahr.<br>Die meisten sind nach wenigen Wochen Müll.",
      "story.a0_statement": "Wir produzieren für die Tonne.",
      "story.a1_kicker": "Die Ungerechtigkeit · Akt II",
      "story.a1_headline_html": "Was wir wegwerfen, verschiffen wir.<br>Woche für Woche stranden Millionen Altkleider an Ghanas Stränden und in der Wüste von Atacama.",
      "story.a1_statement": "Aus den Augen — auf fremde Küsten.",
      "story.a2_kicker": "Das Ökosystem · Akt III",
      "story.a2_headline_html": "Jede Sekunde wird eine Lkw-Ladung Textilien verbrannt oder vergraben.<br>Mikroplastik liegt im Regen, im Fisch — in unserem Blut.",
      "story.a2_statement": "Es kommt immer zu uns zurück.",
      "story.a3_kicker": "Der Mensch · Akt IV",
      "story.a3_headline_html": "Hinter jeder billigen Naht zahlt ein Mensch den echten Preis.<br>Ein Fluss, der einmal Heimat war. Ein Kind neben einem Berg aus unserer Mode.",
      "story.a3_statement": "Niemand sollte diesen Preis tragen.",
    ...
    en: {
      ...
      "story.a0_headline_html": "We sew over 100 billion garments a year.<br>Most are landfill within weeks.",
      "story.a0_statement": "We produce for the bin.",
      "story.a1_kicker": "Act II — The injustice",
      "story.a1_headline_html": "What we throw away, we ship away.<br>Week after week, millions of cast-offs wash up on Ghana's beaches and in the Atacama desert.",
      "story.a1_statement": "Out of sight — onto someone else's shore.",
      "story.a2_kicker": "Act III — The ecosystem",
      "story.a2_headline_html": "Every second, a truckload of textiles is burned or buried.<br>Microplastics are in the rain, in the fish — in our blood.",
      "story.a2_statement": "It always comes back to us.",
      "story.a3_kicker": "Act IV — The human",
      "story.a3_headline_html": "Behind every cheap seam, a person pays the real price.<br>A river that was once home. A child beside a mountain of our fashion.",
      "story.a3_statement": "No one should bear that price.",
