...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "meas.badge_browser": "100% im Browser",
      "meas.badge_device": "Foto bleibt auf dem Gerät",
      "meas.badge_adjust": "Schätzung — jederzeit anpassbar",
      ...
      "aidr.foil_usual": "Übliche KI",
      "aidr.foil_aim": "auf die Nachfrage",
      "aidr.foil_out": "→ mehr kaufen",
      "aidr.you_tag": "Du",
      "aidr.you_val": "Design & Stil",
      "aidr.ai_tag": "KI",
      "aidr.step_reclaim": "sehen · trennen · sortieren",
      "aidr.step_reclaim_sub": "aus weggeworfenem Textil",
      "aidr.step_design_sub": "die Idee kommt von dir",
      "aidr.step_build": "baut dein Stück",
      "aidr.step_build_sub": "autonom gefertigt",
      "aidr.result_tag": "Ergebnis",
      "aidr.result_val": "dein Einzelstück",
      "aidr.kicker_html": "Ein von Menschen geschaffenes Problem lösen — kein neuer Grund zu konsumieren. <strong>Das Design bleibt deins.</strong>",
      ...
      "how.title": "Von deiner Idee zum Einzelstück",
      "how.sub": "Vier Schritte — vom ersten Prompt bis zur dokumentierten Vorlage. Du führst, die Maschine folgt.",
      "how.s1_label": "Du entwirfst",
      "how.s1_line": "Dein Prompt, dein Stil. Die Idee kommt von dir.",
      "how.s2_label": "KI verfeinert",
      "how.s2_line": "Sie schärft deinen Entwurf — sie ersetzt ihn nie.",
    ...
    en: {
      ...
      "meas.badge_browser": "100% in your browser",
      "meas.badge_device": "Photo stays on your device",
      "meas.badge_adjust": "An estimate — adjustable anytime",
      ...
      "aidr.foil_usual": "Usual AI",
      "aidr.foil_aim": "at demand",
      "aidr.foil_out": "→ buy more",
      "aidr.you_tag": "You",
      "aidr.you_val": "Design & style",
      "aidr.ai_tag": "AI",
      "aidr.step_reclaim": "see · separate · sort",
      "aidr.step_reclaim_sub": "from discarded textile",
      "aidr.step_design_sub": "the idea is yours",
      "aidr.step_build": "builds your piece",
      "aidr.step_build_sub": "autonomously made",
      "aidr.result_tag": "Result",
      "aidr.result_val": "your one piece",
      "aidr.kicker_html": "Solving a human-made problem — not inventing a new reason to consume. <strong>The design stays yours.</strong>",
      ...
      "how.title": "From your idea to a one-off",
      "how.sub": "Four steps — from the first prompt to a documented blueprint. You lead, the machine follows.",
      "how.s1_label": "You design",
      "how.s1_line": "Your prompt, your style. The idea is yours.",
      "how.s2_label": "AI refines",
      "how.s2_line": "It sharpens your design — it never replaces it.",
