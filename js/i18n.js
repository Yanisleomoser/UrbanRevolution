...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      "hero.title_html": 'Aus Abfall.<br>Nach deinen Massen.<br><span class="gradient-text">Couture für Einen.</span>',
      "hero.subtitle": "Ein Satz genügt: Die KI entwirft dein Stück, ein Schweizer Schneider näht es aus geretteter Textilfaser — nach deinen Massen, nur für dich.",
      ...
      "manifesto.vision": "Urban Revolution macht aus weggeworfenen Kleidern neuen Stoff. Du beschreibst ein Stück, unsere KI entwirft es, ein Schweizer Schneider näht es nach deinen neun Massen. Ein Kleidungsstück. Einmal gefertigt. Für dich — aus genau dem, was die Branche wegwirft. Kein neuer Rohstoff, keine Überproduktion, keine Deponie.",
      ...
      "story.a5_headline_html": "Aus geretteter Faser wird Couture — KI-entworfen, nach deinen Massen.",
      ...
      "faq.a4": "Drei Wege zu deinen Massen — Foto-Auswertung (1 Klick, 100 % clientseitig), manuelle Eingabe der 9 Werte, oder eine Grössenpresets (S/M/L/XL) als Startpunkt, die du danach anpassen kannst. Schneider erhalten alle Werte in der Produktions-Spec.",
      ...
      // ── Footer ──
      "footer.tagline": "Massgeschneiderte AI-Couture aus Zürich. KI entwirft, Schneider fertigen, du trägst.",
