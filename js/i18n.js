...
const I18N = (() => {
  ...
  const dict = {
    de: {
      ...
      // ── Mission ──
      "mission.heading": "Warum Urban Revolution",
      "mission.b0_eyebrow": "Das Problem · 01",
      "mission.b0_title": "Die Welt ertrinkt in Plastik.",
      "mission.b0_body": "Jedes Jahr landen rund 8 Millionen Tonnen Plastik in den Ozeanen. PET-Flaschen zerfallen über Jahrhunderte — nicht weg, nur kleiner.",
      "mission.b0_stat_html": '<span class="mission-stat-num">8 Mio. t</span> Plastik pro Jahr im Meer',
      "mission.b1_eyebrow": "Das Problem · 02",
      "mission.b1_title": "Mode produziert für den Müll.",
      "mission.b1_body": "Die Industrie fertigt mehr, als die Welt je tragen kann. Jede Sekunde wird eine Lastwagenladung Textilien verbrannt oder deponiert — vieles davon nie getragen.",
      "mission.b1_stat_html": '<span class="mission-stat-num">~92 Mio. t</span> Textilmüll pro Jahr',
      "mission.b2_eyebrow": "Unsere Überzeugung",
      "mission.b2_title": "KI sollte echte Probleme lösen.",
      "mission.b2_body": "Statt nur Feeds zu füllen, kann generative KI Ressourcen sparen: entwerfen und fertigen, was wirklich jemand will. Kein Lager, kein Überschuss, keine Verschwendung.",
      "mission.b2_stat_html": '<span class="mission-stat-num">On demand</span> statt Überproduktion',
      "mission.b3_eyebrow": "Unsere Vision",
      "mission.b3_title": "Deine Kleidung. Aus Plastik gerettet.",
      "mission.b3_body": "Wir verwandeln recyceltes PET in Couture, die nur für dich entsteht — KI-entworfen, nach deinen Maßen gefertigt. Individualität statt Massenproduktion.",
      "mission.b3_stat_html": '<span class="mission-stat-num">~14 PET-Flaschen</span> → 1 Teil · 0.9 kg rPET',
      "mission.cta_html": 'Dein Stück entwerfen <span aria-hidden="true">→</span>',
    ...
    en: {
      ...
      // ── Mission ──
      "mission.heading": "Why Urban Revolution",
      "mission.b0_eyebrow": "The problem · 01",
      "mission.b0_title": "The world is drowning in plastic.",
      "mission.b0_body": "Around 8 million tonnes of plastic end up in the oceans every year. PET bottles break down over centuries — not gone, just smaller.",
      "mission.b0_stat_html": '<span class="mission-stat-num">8 M tonnes</span> of plastic in the sea per year',
      "mission.b1_eyebrow": "The problem · 02",
      "mission.b1_title": "Fashion produces for the landfill.",
      "mission.b1_body": "The industry makes more than the world could ever wear. Every second a truckload of textiles is burned or dumped — much of it never worn.",
      "mission.b1_stat_html": '<span class="mission-stat-num">~92 M tonnes</span> of textile waste per year',
      "mission.b2_eyebrow": "Our conviction",
      "mission.b2_title": "AI should solve real problems.",
      "mission.b2_body": "Instead of just filling feeds, generative AI can save resources: design and produce what someone actually wants. No warehouse, no surplus, no waste.",
      "mission.b2_stat_html": '<span class="mission-stat-num">On demand</span> instead of overproduction',
      "mission.b3_eyebrow": "Our vision",
      "mission.b3_title": "Your clothing. Rescued from plastic.",
      "mission.b3_body": "We turn recycled PET into couture made just for you — AI-designed, produced to your measurements. Individuality instead of mass production.",
      "mission.b3_stat_html": '<span class="mission-stat-num">~14 PET bottles</span> → 1 piece · 0.9 kg rPET',
      "mission.cta_html": 'Design your piece <span aria-hidden="true">→</span>',
