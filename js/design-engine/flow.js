    ...
    function updatePreview(animate) {
      ...
      if (chipsEl) {
        ...
        if (DesignDNA.get(dna, "category")) {
          ...
          if (typeof fit === "number") chips.push(window.I18N ? window.I18N.t(fit < 0.33 ? "fit.slim" : fit > 0.66 ? "fit.oversized" : "fit.regular") : (fit < 0.33 ? "Slim" : fit > 0.66 ? "Oversized" : "Regular"));
